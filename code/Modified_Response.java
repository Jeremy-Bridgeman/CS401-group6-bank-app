...
// This full file is Jeremey's work with a bit 
// of modification to work with my ATM
// All not finalized
// This entire file can be interchanged with the 
// original response
...
public class Modified_Response implements Serializable {
	...
	public Modified_Response(String message, RESPONSE_TYPE type ) {
		this.message = message;
		this.type = type;
		
		// changing this text = t set text
		// changing this too type = r;	set response type
	}
